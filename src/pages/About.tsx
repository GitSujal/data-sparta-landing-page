              ...
              <div className="bg-content1 p-6 rounded-lg shadow-lg">
                ...
                <blockquote className="mt-6">
                  ...
                  <footer className="mt-3">
                    <p className="text-base font-semibold text-foreground">Sujal Dhungana</p>
                    <p className="text-base text-foreground/60">Founder & Lead Data Engineer</p>
                  </footer>
                </blockquote>
              </div>
            </div>
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {values.map((value) => (
              ...
              >
                ...
                <p className="mt-2 text-foreground/60 text-center">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
